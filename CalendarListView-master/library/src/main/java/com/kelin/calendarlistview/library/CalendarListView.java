...
//        listView.setVisibility(GONE);
    ...
    public void setOnListItemClickListener (PinnedHeaderListView.OnItemClickListener listener)
    {
        listView.setOnItemClickListener(listener);
        Toast.makeText(getContext(),"ListItem clicked",Toast.LENGTH_SHORT);
    }
...
//                        listView.smoothScrollToPosition(listPos);
    ...
    public void  SetAddNewJobBtnClickListener(OnClickListener listener)
    {
        listView.getAddNewJobBtn().setOnClickListener(listener);
    }
